...
//Building Random Number
const randomWhatsapp = document.querySelector("#number1");
const phone = document.querySelector("#number2");
const phoneArr = [
  "tel:+6012-2246810",
  "tel:+6016-5934156",
  "tel:+6012-3613338",
];
const whatsappArr = ["60122246810", "60165934156", "60123613338"];
const randomNum = Math.floor(Math.random() * 3);

randomWhatsapp.href = `https://api.whatsapp.com/send/?phone=${whatsappArr[randomNum]}&text&app_absent=0`;
phone.href = phoneArr[randomNum];
